...
public:
    ...
    rg::InsertOrderMap<std::string, int> WORLD_LAYERS = {
            {"water", 0}, //
            {"bg", 1}, //
            {"shadow", 2}, //
            {"main", 3}, //
    ...
    std::map<std::string, rl::Color> COLORS = {
    ...
    std::map<std::string, int> BATTLE_LAYERS = {
            {"outline", 0}, //
            {"name", 1}, //
            {"monster", 2}, //
            {"effects", 3}, //
    ...
    std::map<std::string, std::vector<std::pair<std::string, BattleChoice>>> BATTLE_CHOICES{
